...
**A workshop for programming the filecoin deal market and making Data DAOs**
...
3. [Solidy CBOR parsing functions](https://github.com/lotus-web3/client-contract/blob/main/src/CBORParse.sol#L129) of general use reading filecoin native data
4. A place to put your 
